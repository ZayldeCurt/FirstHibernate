            ...
            <div class="row">
                <form action="/productAdmin" method="post">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" id="name" placeholder="Nazwa produktu">
                    </div>
                    <div class = "form-group">
                    ...
                    <div class = "form-group">
                        ...
                        <input type="text" class="form-control" id="grossPrice" name="grossPrice" placeholder="cena brutto">
                    </div>
                    <div class = "form-group">
